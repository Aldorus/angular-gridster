    ...
    return angular.module('gridster', [])
        ...
        .controller('GridsterCtrl', ['gridsterConfig', '$timeout',
            function (gridsterConfig, $timeout) {
                 ...
                 */
                this.updateHeight = function updateHeight(plus) {
            ...
            function ($document, $window, GridsterTouch) {
                function GridsterDraggable($el, scope, gridster, item, itemOptions) {
                    ...
                    function drag(event) {
                        ...
                        if ((gridster.swapping === true && hasItemsInTheWay) || (gridster.swappingLine === true && hasItemsInTheWay)) {
                            ...
                            if ((gridster.swapping === true && hasItemsInTheWay) || (gridster.swappingLine === true && hasItemsInTheWay && sameRow && sameSize)) {
                ...
                return {
                    ...
                    link: function (scope, $el, attrs, controllers) {
                        ...
                        var updateResizable = function () {
                            resizable.toggle(!gridster.isMobile && gridster.resizable && (gridster.resizable.enabled || gridster.resizable.enabledLine));
                        };
                        updateResizable();

                        var updateDraggable = function () {
                            draggable.toggle(!gridster.isMobile && gridster.draggable && (gridster.draggable.enabled || gridster.draggable.enabledLine));
                        };
                        updateDraggable();
